    ...
    const fetchActiveEmployees = async () => {
        ...
        try {
            ...
            const active = res.data
                ...
                .map(app => {
                    const baseSalary = parseInt(app.workerData?.financial?.liquidSalary || 500000); // Default IMM si no hay
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-slate-50/50">
                                    ...
                                    <th className="px-5 py-5 text-[9px] font-black uppercase tracking-[0.2em] text-slate-800 bg-slate-100 text-right">Líquido</th>
