...
const { registerCompany, getCompanies, updateCompany, deleteCompany, bulkRegisterCompanies, getCompanyPublic } = require('../controllers/companyController');
...
router.get('/:id/public', getCompanyPublic);
